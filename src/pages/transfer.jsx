          ...
          <div className="grid md:grid-cols-3 gap-5 md:px-20">
            <div className="p-5 bg-[#ffcfcfb5] drop-shadow-3xl rounded-lg mb-5">
              <div className="text-center">
                <h1 className="text-2xl font-[900] text-primary mb-3">
                  Financial Security
                </h1>
                <p className="text-sm md:text-base">Peace of mind.</p>
              </div>
            </div>
            <div className="p-5 bg-[#d8d9cfad] drop-shadow-3xl rounded-lg mb-5">
              <div className="text-center">
                ...
                <p className="text-sm md:text-base">Investment and growth.</p>
              </div>
            </div>
            <div className="p-5 bg-[#ffcdb88e] drop-shadow-3xl rounded-lg mb-5">
              <div className="text-center">
                ...
                <p className="text-sm md:text-base">Safety net.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <div className="md:full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-sm md:text-base">
                  Secure your financial future by intelligently investing your
                  savings, harnessing the power of AI to steadily multiply your
                  wealth over time.
                </p>
              </div>
            </Slide>
          ...
          >
            ...
            >
              <div className="md:w-full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-sm md:text-base">
                  Embark on a seamless journey toward your financial milestones
                  through disciplined savings and strategic financial planning,
                  guided by AI.
                </p>
              </div>
            </Slide>
          ...
          >
            ...
            >
              <div className="md:full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-sm md:text-base">
                  Embrace the effortless growth of your money through automated
                  savings, paving the way for a secure and prosperous financial
                  future with the aid of AI.
                </p>
              </div>
            </Slide>
          </div>
