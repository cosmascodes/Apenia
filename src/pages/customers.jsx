...
function Customers() {
  return (
    <>
            ...
            >
              <div className="md:full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-[14px]">
                  Through AI-driven investment strategies, witness your savings
                  grow exponentially, fortifying your financial future with
          ...
          >
            ...
            >
              <div className="md:w-full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-[14px]">
                  Empowered by disciplined savings and AI-driven financial
                  planning, reaching your financial milestones unfolds as a
                  seamless and achievable journey.
                </p>
              </div>
            </Slide>
          </div>
          ...
          >
            ...
            >
              <div className="md:full font-[Mulish] text-center md:text-left">
                ...
                <p className="mb-5 mt-5 md:w-[315px] text-[14px]">
                  Embrace the ease of AI-driven automated savings, witnessing
                  your wealth grow effortlessly, paving the way for a secure and
      ...
      <section className="mt-12 border-t border-t-slate-200">
        <Footer />
      </section>
    </>
  );
